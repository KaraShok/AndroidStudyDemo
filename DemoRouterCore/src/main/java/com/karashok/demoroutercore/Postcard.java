 ...
 * @since 05-28-2022
 */
public class Postcard extends DRouterMeta {
    ...
    public Object navigation(Context context, NavigationCallback callback) {
        return DRouter.getInstance().navigation(context, this, -1, callback);
    }
    ...
    public Object navigation(Activity activity, int requestCode, NavigationCallback callback) {
        return DRouter.getInstance().navigation(activity, this, requestCode, callback);
    }
}
