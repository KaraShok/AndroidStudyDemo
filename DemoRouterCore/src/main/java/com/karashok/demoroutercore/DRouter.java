...
public class DRouter {
    ...
    private static final String TAG = "DRouter";
    private static final String ROUTE_ROOT_PAKCAGE = "com.karashok.demoroutercore";
    private static final String SDK_NAME = "DRouter";
    private static final String SEPARATOR = "$$";
    private static final String SUFFIX_ROOT = "Root";
    private static Application mContext;

    private static DRouter instance;
...
//        }
    ...
    private void prepareCard(Postcard card) {
        DRouterMeta routeMeta = Warehouse.routes.get(card.getPath());
        //还没准备的
        if (null == routeMeta) {
