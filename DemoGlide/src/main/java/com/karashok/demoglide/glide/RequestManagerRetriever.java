...
import com.karashok.demoglide.glide.manager.ApplicationLifecycle;
import com.karashok.demoglide.glide.manager.SupportRequestManagerFragment;
...
public class RequestManagerRetriever implements Handler.Callback {
    ...
    private SupportRequestManagerFragment getSupportRequestManagerFragment(FragmentManager fm) {
        ...
        if (fragment == null) {
           ...
           if (fragment == null) {
               ...
               // 所以使用一个sopports临时集合
               handler.obtainMessage(REMOVE_SUPPORT_FRAGMENT,fm)
                       .sendToTarget();
           }
        }
        return fragment;
    ...
    public boolean handleMessage(@NonNull Message msg) {
        if (REMOVE_SUPPORT_FRAGMENT == msg.what) {
