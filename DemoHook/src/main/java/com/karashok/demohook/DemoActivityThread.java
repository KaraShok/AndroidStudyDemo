...
/**
 * 即将要加载的时候，需要把ProxyActivity 给 换回来，换成目标LoginActivity，我们也称为【还原操作】
 */
public class DemoActivityThread {

    private Context context;

    public DemoActivityThread(Context context) {
        ...
        public boolean handleMessage(Message msg) {
            if (Constants.LAUNCH_ACTIVITY == msg.what) {
                ...
                try {
                    ...
                    Intent targetIntent = proxyIntent.getParcelableExtra(Constants.TARGET_INTENT);
                    if (targetIntent != null) {
                        //集中式登录
                        SharedPreferences share = context.getSharedPreferences("DemoHook",Context.MODE_PRIVATE);
