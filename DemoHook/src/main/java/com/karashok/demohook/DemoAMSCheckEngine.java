...
/**
 * @author KaraShokZ.
 * @des 专门处理绕过AMS检测，让LoginActivity可以正常通过
 * @since 06-04-2022
 */
public class DemoAMSCheckEngine {
     ...
     */
    public static void mHookAMS(final Context mContext) throws ClassNotFoundException, NoSuchFieldException,
                ...
                new InvocationHandler() {
                    ...
                    public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
                        if ("startActivity".equals(method.getName())) {
                            ...
                            proxyIntent.putExtra(Constants.TARGET_INTENT, target);
                            args[2] = proxyIntent;
                        }
